...
\item The binding constraint is the menu, not the optimizer. Twenty-eight long-only factor indices hold 1.31 independent risk bets, and three asset
...
anti-data-mining defence. On our own holdings, one index line per region and factor, which we call sleeves throughout,
every factor beats its regional Reference in compound annual growth over the full window (Enhanced Value
