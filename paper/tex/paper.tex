...
has 56\% power at the 5\% level. The smallest gap the design could detect at a given target power follows from the same standard
...
and gold, delivers a Sharpe ratio of 0.95 at 8.7\% volatility with a $-16.7$\% maximum drawdown, is statistically indistinguishable from the
