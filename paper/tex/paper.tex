...
\head{Data availability.} The study draws on four sources. Three are freely redistributable and
ship with the repository: FRED, the Ken French data library, and an LBMA gold mirror. The fourth,
